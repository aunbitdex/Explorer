...
export function placeHolderBlock (blockNumber) {
  return `
    <div
      class="fade-down-blocks-chain fade-up"
      data-block-number="${blockNumber}"
      data-selector="place-holder"
    >
      <div
        class="blocks-chain-body-content"
      >
        <div 
          class="fade-blocks-chain-child"
        >
          <div class="tile-transaction-block col-md-1 d-flex flex-row flex-md-column">
